...
import { User, Campaign, Donation, CampaignLedger, Disbursement, ImpactProof, CampaignReport, OrgVerification, AuditLog } from "../types";
import {
  Landmark,
  Users,
  TrendingUp,
...
export default function AdminDashboard({
  ...
  const [activeTab, setActiveTab] = useState<
    "analytics" | "campaigns" | "reports" | "organizations" | "treasury" | "proofs" | "users" | "audit"
  >("analytics");
